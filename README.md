...
The build outputs a GitHub Pages-ready `dist/` directory with relative asset paths, a `.nojekyll` marker, and a `404.html` fallback for the `/stroke-tl-dashboard/` repository path.
...
Open `http://localhost:4173/stroke-tl-dashboard/`.
